...
public partial class MainWindow : Window
{
    ...
    private void PushTasks()
    {
        ...
        var tasks = proj.Tasks.Select(t => new
        {
            ...
            release      = t.Release,
            merge        = t.Merge,
            mergeBlocked = t.Merge && proj.MergeBlockerCount(t) > 0,
            mergeBlockerCount = t.Merge ? proj.MergeBlockerCount(t) : 0,
            branch       = t.Branch,
    ...
    private void OnOverlayChanged()
    {
        ...
        if (vm.Overlay is TaskFormViewModel form)
        {
            ...
            var payload = new
            {
                ...
                approvals    = TaskItem.SplitApprovalItems(form.Requirements).ToArray(),
                notes        = form.Notes,
